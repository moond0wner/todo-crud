...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_moond0wner_todo-nilchan_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Фильтрая задач по ID пользователя",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal servver error",
                        "schema": {
                            "$ref": "#/definitions/github_com_moond0wner_todo-nilchan_internal_core_transport_http_response.ErrorResponse"
                        }
                    }
    ...
    "definitions": {
        "github_com_moond0wner_todo-nilchan_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.CreateTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    ...
                    "maxLength": 1000,
                    "minLength": 1,
                    "example": "Выполнить задание до четверга"
                },
                "title": {
                    "type": "string",
                    "maxLength": 100,
        ...
        "internal_features_tasks_transport_http.PatchTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Проснуться утром в 6"
                },
                "title": {
                    "type": "string",
                    "example": "Встать на учебу"
                }
            }
        },
